...
_MRCSTATUS_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='mesycontrol.proto.MRCStatus.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MRCSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='mesycontrol.proto.MRCStatus.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='mesycontrol.proto.MRCStatus.info', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='mesycontrol.proto.MRCStatus.version', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='has_read_multi', full_name='mesycontrol.proto.MRCStatus.has_read_multi', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MRCSTATUS.fields_by_name['status'].enum_type = _MRCSTATUS_STATUS
_MRCSTATUS_STATUS.containing_type = _MRCSTATUS
