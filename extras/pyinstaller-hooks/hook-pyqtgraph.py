...
def pyqtgraph_module_filter(modname):
    excluded_submodules = ['pyqtgraph.examples']
    return modname not in excluded_submodules

all_imports = collect_submodules("pyqtgraph", filter=pyqtgraph_module_filter)
